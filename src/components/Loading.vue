    ...
    >
        <div v-if='showing' :class='{"white-overlay": overlay}'>
            <div class='loader-wrapper'>
                <div class='pulled-left' style='padding: 10px 20px'>{{labelPrint}}</div>
                <div class='wrapper'>
                    <div class='spinner-container'>
                        <div class='spinner-layer spinner-layer--horizon'>
